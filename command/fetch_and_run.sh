...
if [[ "$CVMFS_DISABLE" == "false" ]]; then
    CVMFS_REPO="${SCIBERGET_CVMFS_REPO:-sciberget.example.org}"
    CVMFS_MODS_PATH="/cvmfs/${CVMFS_REPO}/sciberget-modules"
    ...
    if [ -e "${CONTAINER_FILE_NAME}" ]; then
        ...
        if [ $? -eq 0 ]; then
            ...
            if [ $? -eq 0 ]; then
                ...
                echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
                echo "[ERROR] fetch_and_run.sh line $LINENO: the container ${CONTAINER_FILE_NAME} doesn't exist. There is something wrong with the container download. Please ask for help here with the output of this window: https://github.com/ "
                echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
                read -n 1 -s -r -p "Press any key to continue..."
            fi
        fi
        ...
        echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
        echo "[ERROR] fetch_and_run.sh line $LINENO: the container ${CONTAINER_FILE_NAME} doesn't exist. There is something wrong with the container download or CVMFS. Please ask for help here with the output of this window: https://github.com/ "
        echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
        read -n 1 -s -r -p "Press any key to continue..."
    fi
else
