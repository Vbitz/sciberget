...
This module provides validation for sci-ber-get YAML recipes using attrs classes.
"""
...
# Categories mirror Kali's tool/metapackage groupings. They are used for
# metadata and menu organization; recipes remain focused per tool/suite.
CATEGORIES = [
